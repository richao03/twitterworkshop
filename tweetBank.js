...
var data = [{name: "Richard", text: "Random", id: "62"}, {name: "Tammy Chu", text: "Other Random", id: "12"}];

function add (name, text) {
  var counter = parseInt(Math.random()*100)
...
// var object = find(function(obj) {
//   return  obj.name === 'Richard Chao  '
// });
